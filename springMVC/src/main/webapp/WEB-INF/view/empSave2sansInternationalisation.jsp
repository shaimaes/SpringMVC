...
<body>
	...
	<springForm:form method="POST" modelAttribute="employee"
		...
		<table>
			...
			<td>
			<springForm:radiobutton path="Gender" value="Male" label="Male" /> 
			<springForm:radiobutton path="Gender" value="Female" label="Female"/>
			 </td>
			...
			<td>
			<springForm:checkbox path="Food" value="BreakFast" label="BreakFast"/>
			<springForm:checkbox path="Food" value="Lunch" label="Lunch"/>  
			<springForm:checkbox path="Food" value="Dinner" label="Dinner"/>  
			</td>
			<td><springForm:errors path="Food" cssClass="error" /></td>
			</tr>
			<tr>
